...
<body>
	...
	<div class="container projects">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-4 col-lg-3 ">
				<div class="thumbnail" style="height: 336px;">
					<a title="比动漫有趣的日语入门课" href="#" target="_blank"> <img
						width="300" height="150" class="lazy" src="img/japanes.jpg">
					</a>
					<div class="caption">
						<h3>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 ">
				<div class="thumbnail" style="height: 336px;">
					<a title="教你用中文思维学韩语" href="#" target="_blank"> <img
						width="300" height="150" class="lazy" src="img/Korean.jpg">
					</a>
					<div class="caption">
						<h3>
							<a title="教你用中文思维学韩语" href="#" target="_blank">教你用中文思维学韩语<br>
							<small>教你用中文思维学韩语</small></a>
						</h3>
						<p>法语入门_从零开始学法语-法语字母-法语语音-在线学法语-初级法语</p>
					</div>
				</div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 ">
				<div class="thumbnail" style="height: 336px;">
					<a title="零基础快速入门泰语" href="#" target="_blank"> <img width="300"
						height="150" class="lazy" src="img/thai.png">
					</a>
					<div class="caption">
						<h3>
							<a title="零基础快速入门泰语" href="#" target="_blank">零基础快速入门泰语<br>
							<small>零基础快速入门泰语</small></a>
						</h3>
						<p>法语入门_从零开始学法语-法语字母-法语语音-在线学法语-初级法语</p>
					</div>
				</div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3 ">
				<div class="thumbnail" style="height: 336px;">
					...
					<div class="caption">
						<h3>
							<a title="浪漫法语入门精选" href="#" target="_blank">浪漫法语入门精选<br>
							<small>浪漫法语入门精选</small></a>
						</h3>
						<p>法语入门_从零开始学法语-法语字母-法语语音-在线学法语-初级法语</p>
					</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-group" action="">
						...
						<div class="form-group">
							<label for="">电话</label> <input class="form-control" type="email"
								placeholder="请输入电话">
						</div>
