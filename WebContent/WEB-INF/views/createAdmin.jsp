	...
	<div class="container-fluid">
		...
		<div class="row" style="margin-top: 2%">
			...
			<div class="col-md-2 text-center">
				...
				<br>
				<button type="button" class="btn btn-success">+创建普通管理员账户</button>
			</div>
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-12">
				...
				<form action="${pageContext.request.contextPath}/createAdmin.do"
					method="post">
					<table class="table">
						<thead>
							<tr>
						...
						<tbody>
							...
							<tr class="table-success">
								<td></td>
								<td><input type="submit" class="btn btn-success" value="创建"></a>
								</td>
							</tr>
						</tbody>
					</table>
