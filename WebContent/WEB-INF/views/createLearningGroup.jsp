				...
				<div class="row">
					...
					<div class="col-md-6">
						<h5 class="text-right text-info"
							style="margin-bottom: 0%; margin-top: 3%;">创建学习组</h5>
					</div>
				</div>
				<form
					action="${pageContext.request.contextPath}/createLearningGroup.do" method="post">
					<input type="hidden" name="creator" value="${sessionScope.user.id }" />
					<table class="table">
						<thead>
							<tr>
						...
						<tbody>
							...
							<tr class="table-warning">
								<td></td>
								<td><input type="submit" class="btn btn-success" value="确认创建"></td>
							</tr>
						</tbody>
					</table>
				</form>
