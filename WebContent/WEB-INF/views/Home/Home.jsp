...
<body>
  <!--导航条：navbar这是一个导航条，navbar-fixed-top让导航条固定在顶部,navbar-inverse改变导航条的外观，变成黑色-->
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-right hidden-sm">
                    <li>
                    	<a data-toggle="tooltip" data-placement="bottom" title="这是第三方入口，点击可浏览用户分享的资料" 
                    	href="${pageContext.request.contextPath}">第三方入口</a>
                    </li>
    ...
    <!--巨幕-->
    <div class="jumbotron " style="background-color: rgb(132, 180, 146)">
        <div class="container">
            <br /><br /><br />
            <h1 style="text-align: center; color: white;"><b>Language Learning</b></h1>
            <h2 style="text-align: center;color: white;"> 学习一门语言的方法就是要尽量多地练习</h2>
            <br />
            <p style="text-align: center;"><a class="btn btn-lg btn-default btn-shadow" href="NewsPage.html">点此阅读外语新闻</a></p>
        </div>
        <p style="text-align: center;"><a href="Download.html" style="color: white;"><small><small>点此下载资料</small></small></a></p>
        <br />
    </div>
    <!--巨幕-->
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-3 ">
                <div class="thumbnail" style="height: 336px;">
                    ...
                    <div class="caption">
                        <h3>
                            <a title="浪漫法语入门精选" href="Video.html" target="_blank">浪漫法语入门精选<br><small>浪漫法语入门精选</small></a>
                        </h3>
