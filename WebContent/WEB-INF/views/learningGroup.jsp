		...
		<div class="row" style="margin-top: 2%">
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-6">
						<a
							href="${pageContext.request.contextPath}/returnCreateLearningGroup.do"
							class="btn btn-success">+创建学习组</a>
					</div>
					<div class="col-md-6">
						<h5 class="text-right text-info"
							style="margin-bottom: 0%; margin-top: 3%;">当前课程：Java程序设计</h5>
					</div>
				</div>
				<table class="table">
					<thead>
						<tr>
							<th style="border-top-width: 0px">组名称</th>
							<th style="border-top-width: 0px">组编号</th>
							...
							<tr class="table-warning">
								...
								<td>
									<button type="button" class="btn btn-outline-primary">
										进入学习组</button> <a
									href="${pageContext.request.contextPath}/returnEditLearningGroup.do?id=${group.id}"
									class="btn btn-info">编辑</a>
									<a href="${pageContext.request.contextPath}/deleteLearningGroup.do?id=${group.id}"
